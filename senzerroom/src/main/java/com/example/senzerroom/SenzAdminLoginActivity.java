 ...
 */
public class SenzAdminLoginActivity extends Activity implements LoaderCallbacks<Cursor> {
     ...
     */
    private static final String[] VALID_CREDENTIALS = new String[]{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_senz_admin_login);
    ...
    private void addEmailsToAutoComplete(List<String> emailAddressCollection) {
        ...
        ArrayAdapter<String> adapter =
                new ArrayAdapter<>(SenzAdminLoginActivity.this,
